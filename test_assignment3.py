...
arturos_test1 = Word_Encoder('msg')
arturos_test2 = Word_Decoder(arturos_test1)
print(f"{arturos_test1} morse code is equal to '{arturos_test2}'")
'''
